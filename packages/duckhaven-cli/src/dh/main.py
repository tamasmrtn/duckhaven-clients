...
from dh.commands import admin as admin_commands
from dh.commands import api as api_commands
...
app.add_typer(catalog_commands.agent_app)
...
app.add_typer(api_commands.app)
